                  ...
                  <form action="" method="POST" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-6 col-xs-12">
                          <input type="text" name="number" value="{{$intro->number}}"  style="margin-left: -10px"   class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-6 col-xs-12">
                          <input type="text" name="address" value="{{$intro->address}}" id="name" style="margin-left: -10px"   class="form-control col-md-7 col-xs-12">
