...
<div class="x_panel">
                ...
                <div class="x_content">
                  <form action="addbanner" method="POST" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                      @csrf
                      ...
                      <div class="form-group">
                            ...
                            <textarea class="col-md-6 col-sm-6 col-xs-12 ckeditor"  name="title" id="Mo_ta" style="width: 655px;" rows="10"></textarea>
                        </div>
                          <div id="alerts"></div>
