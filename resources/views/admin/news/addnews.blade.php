...
<div class="x_panel">
                ...
                <div class="x_content">
                  <form action="addnews" method="POST" enctype="multipart/form-data" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                      @csrf
                      <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-6 col-xs-12">
                          <input type="text" name="title"  style="margin-left: -10px"   class="form-control col-md-7 col-xs-12">
                          @if($errors->has('title'))
                            {{$errors->first('title')}}
                          @endif
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-6 col-xs-12">
                          <select name="kindnew" id="input"  style="padding: 3px;">
                            <option >Chọn loại tin</option>
                            <option  value="moitruong">Tin môi trường</option>
                            <option  value="hoatdongqui">Tin hoạt động của quĩ</option>
                            <option value="hoptacpt">Hợp Tác Phát triển</option>
                            <option  value="congnghe">Khoa học công nghệ</option>
                          </select>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-6 col-xs-12">
                          <input type="file" name="images"  style="margin-left: -10px"   class="form-control col-md-7 col-xs-12">
                          @if($errors->has('img'))
                            {{$errors->first('img')}}
                          @endif
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-6 col-xs-12">
                          <input type="text" name="summary" id="name" style="margin-left: -10px"   class="form-control col-md-7 col-xs-12">
