...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <form action="{{route('getsearchsv')}}" method="get" >
                        ...
                        <table id="datatable-keytable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable-keytable_info" style="position: relative;">
                            ...
                            <tbody> 
                              ...
                              <tr role="row" class="odd">
                                ...
                                <td>{{$it->status}}</td>
                                <td>
                                  <a href="editservices/{{$it->id}}">
                                    Sửa |
                                  </a>
                                  <a href="delservices/{{$it->id}}" onclick="return confirm('Bạn thích xóa không?')">
                                    Xóa 
                                  </a>
                                </td>
                              </tr>
