    ...
    <div class="row">
      <div class="col-md-12">
       <ul class="br-menu" style="float: right;">
         <li><a class="lang" key="thuvien" href="{{route('thu-vien') }}">Thư Viện</a></li>
         <li><a class="lang" key="hoidap" href="{{route('hoi-dap')}}">Hỏi Đáp</a></li>
         <li><a class="lang" key="lienhe" href="lienhe">Liên Hệ</a></li>
         <li><a class="lang" key="" href="#">RSS</a></li>
         <li><a class="lang" key="sodo" href="#">Sơ Đồ </a></li>
         <li><a class="lang" key="dangnhap" href="admin/login">Đăng Nhập</a></li>
